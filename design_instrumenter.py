...
def main(argv):
    ...
    if (args.mode == "instrumenter_stream"):
        instrument_semantic_information()
    else:
        print(f"Unknown or missing mode: {args.mode}. Supported modes: instrumenter_stream", file=sys.stderr)
        return 1
